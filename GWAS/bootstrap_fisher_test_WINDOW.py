## GWAS Window Bootstrap Fisher Test Analysis
## Tests enrichment of splicing in genes within 10kb windows of GWAS regions
## Analyses disease categories with bootstrap downsampling for both biotype groups
## Usage: Ensure all GWAS window files are in working directory
## Created by B270551
##---------------------------------------------------------##
...
gwas_categories = {
    "immune": "immune_gwas_regions_within10_UNIQUE.txt",
    "brain": "brain_gwas_regions_within10_UNIQUE.txt",
    "cancer": "cancer_gwas_regions_within10_UNIQUE.txt",
    "all": "all_gwas_regions_within10_UNIQUE.txt",
    "non_gwas": "non_gwas_genes.bed",
    "random_genes": "random_background_genes.bed",
    "positive_gwas_all": "positive_gwas_all_within10.txt"
}
...
results_df[results_df["clade"].str.contains("protein_coding")].to_csv(
    "fisher_tests_gwas_protein_coding_WINDOW_BOOTSTRAP.tsv", sep="\t", index=False
)
results_df[results_df["clade"].str.contains("non_protein_coding")].to_csv(
    "fisher_tests_gwas_non_protein_coding_WINDOW_BOOTSTRAP.tsv", sep="\t", index=False
)

print("Analysis complete. Results saved to 'fisher_tests_gwas_protein_coding_WINDOW_BOOTSTRAP.tsv' and 'fisher_tests_gwas_non_protein_coding_WINDOW_BOOTSTRAP.tsv'")
